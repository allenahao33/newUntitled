...
public class HelloWord {
    ...
    *//*
    ...
    private String userAaa; // 客户的名字
    
    private String dd; //
    private String dd; // djl
    private int dd ; //dd d
   ...
   // public static void main(String[] args) {
        ...
        49.Ctrl+shift+f 格式化代码
        50.1模板 ：psvm : 可生成 main 方法
        50.2模板 ：sout : System.out.println() 快捷输出
        50.3模板 ：fori : 可生成 for 循环  // iter 增强for
        50.4模板 ：list.for 增强for
        50.5模板 ：ifn：可生成 if(xxx = null)
       */
       /* System.out.println("zzhes ");
        List<String> list = new ArrayList<>();
        System.out.println("d djdlj ");
        System.out.println("d djdlj ");
        System.out.println();
        System.out.println("d eee ");
        System.out.println();
        System.out.println();
        System.out.println("ddjdjjd 111111");*/


   // }
     //1模板 ：psvm : 可生成 main 方法
    public static void main(String[] args) {
       //2模板 ：sout : System.out.println() 快捷输出
       System.out.println();
       String[] arry=new String[]{"ddd","ddf","dsfdf","dfdf","dfdffdf"};
        //2模板 ：fori : 可生成 for 循环  // iter 增强for
